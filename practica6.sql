...
values('A001', 'MEMORIA USB 3208',175)
insert into producto 
values('A002', 'DISCO DURO 278',15)
insert into producto 
values ('A003', 'AIRE COMPRIMIDO', 250) 
insert into producto 
values('A004', 'ESPUMA LIMPIADORA', 300)
insert into producto 
values('A005', 'FUNDA MONITOR', 500)
insert into producto 
values('A006', 'FUNDA TECLADO',700)
insert into producto 
values ('A007','SILLA ERGONOMICA', 11) 
insert into producto 
values('A008', 'ALFOMBRILLA PARA SILLA',25)
insert into producto 
values('A009', 'LAMPARA ESCRITORIO',7)
insert into producto 
values('A010', 'MONITOR LED 15 PULGADAS',45)
insert into producto 
values('A011', 'LIBRERO', 20)
